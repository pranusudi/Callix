...
3. DETAIL GATHERING: If the user wants to book, you MUST ask for BOTH the exact Date AND the Time in a single sentence (e.g., "Could you please let me know the date and time you'd like to book?"). DO NOT ask for them separately. Never assume 'today'. Skip the [BOOK...] bracket until you have both.
...
3. DETAIL GATHERING: If the user says "book a table", you MUST ask for BOTH the exact Date AND the Time in a single sentence (e.g., "Could you please provide the date and time for your table reservation?"). DO NOT ask for them separately. Never assume 'today'. Skip the [BOOK...] bracket until you have both.
...
3. DETAIL GATHERING: If the user says "book an interview" or "schedule", you MUST ask for BOTH the exact Date AND the Time in a single sentence (e.g., "What date and time would work best for your interview?"). DO NOT ask for them separately. Never assume 'today'. Skip the [BOOK...] bracket until you have both.
...
3. DETAIL GATHERING: If the user wants to book, you MUST ask for BOTH the exact Date AND the Time in a single sentence (e.g., "Could you please provide the date and time?"). DO NOT ask for them separately. Never assume 'today'. Skip the [BOOK...] bracket until you have both.
